...
namespace Client
{
    static class Program
    {
        ...
        static void Main()
        {
	        ...
	        if (Properties.Settings.Default.NeedsUpdating)
	        {
		        Properties.Settings.Default.Upgrade();
				Properties.Settings.Default.NeedsUpdating = false;
		        Properties.Settings.Default.Save();
	        }

            if (String.IsNullOrWhiteSpace(Properties.Settings.Default.GameClientDirectory) || Properties.Settings.Default.ForceVersion == "Invalid")
            {
